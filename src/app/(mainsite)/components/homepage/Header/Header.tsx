...
return (
 <header className={styles.header}>
    ...
    <p>We are fully licensed and insured, and we can travel up to 60 miles from our location at 1041 South Broadway Street #894, Geneva, Ohio 44041. <br /> <strong>Soon to be an LLC, trademarked and registered with the BBB!</strong>
    </p>
